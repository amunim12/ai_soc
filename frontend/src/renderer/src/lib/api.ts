...
export const api = {
  ...
  soarExecutions:  (limit = 100) => get<SoarExecutionDetail[]>(`/api/soar-dash/executions?limit=${limit}`),
  soarTelemetry:   (hours = 24)  => get<SoarTelemetryPoint[]>(`/api/soar-dash/telemetry?hours=${hours}`),
