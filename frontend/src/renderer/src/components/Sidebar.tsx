...
export default function Sidebar({ active, onNavigate, pendingCount, user, onLogout }: SidebarProps) {
      ...
      <div className="sidebar-footer">
        ...
        >
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            ...
            <div style={{ fontSize: 10, color: isAdmin ? '#c4b5fd' : '#64748b', textTransform: 'uppercase', letterSpacing: '0.06em' }}>
              {user.role}
            </div>
          </div>
          <button
            ...
            style={{
              ...
              color: '#475569', fontSize: 14, padding: '2px 4px',
